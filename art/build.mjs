...
import { vfxOutputs } from './vfx.mjs';
...
const classroom = { ...classroomOutputs(root), ...kittenOutputs(root), ...teacherOutputs(root), ...neighbourOutputs(root), ...paperOutputs(root), ...duckOutputs(root), ...uiOutputs(root), ...vfxOutputs(root) };
