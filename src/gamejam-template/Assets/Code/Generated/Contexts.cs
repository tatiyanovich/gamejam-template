...
public partial class Contexts {
    ...
    public const string SceneEntityGuid = "SceneEntityGuid";
    ...
    public void InitializeEntityIndices() {
        game.AddEntityIndex(new Entitas.PrimaryEntityIndex<GameEntity, int>(
            ...
            (e, c) => ((Code.Infrastructure.EntityComponentSystem.Id)c).Value));

        game.AddEntityIndex(new Entitas.EntityIndex<GameEntity, int>(
            OwnerId,
            game.GetGroup(GameMatcher.OwnerId),
            (e, c) => ((Code.Common.OwnerId)c).Value));

        game.AddEntityIndex(new Entitas.EntityIndex<GameEntity, string>(
            SceneEntityGuid,
            game.GetGroup(GameMatcher.SceneEntityGuid),
            (e, c) => ((Code.Common.SceneEntityGuid)c).Value));
    }
}
...
public static class ContextsExtensions {
    ...
    public static System.Collections.Generic.HashSet<GameEntity> GetEntitiesWithSceneEntityGuid(this GameContext context, string Value) {
        return ((Entitas.EntityIndex<GameEntity, string>)context.GetEntityIndex(Contexts.SceneEntityGuid)).GetEntities(Value);
    }
}
//------------------------------------------------------------------------------
// <auto-generated>
