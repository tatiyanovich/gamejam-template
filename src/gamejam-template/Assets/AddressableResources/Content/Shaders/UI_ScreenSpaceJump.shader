    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            Varyings vert(Attributes IN)
            {
                ...
                // _ProjectionParams.x is +1 / -1 depending on whether the projection is flipped.
                OUT.positionHCS.y += _ProjectionParams.x * _JumpBy * abs(sin(_Time.y * _SpeedMul));
